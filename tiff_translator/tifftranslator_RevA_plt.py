...
if args.pattern == "geo":
    ...
    # 投影坐标
    # rcx_point = [[746465.527, 2565001.63],
    #              [746465.633, 2564996.489],
    #              [746478.666, 2564996.796],
    #              [746478.786, 2565001.913],
    #              [746470.446, 2564998.372],
    #              [746467.609, 2564999.091]]
    # ldk_point = [[746524.511, 2564946],
    #              [746524.859, 2564932.497],
    #              [746559.308, 2564933.29],
    #              [746559.679, 2564946.784],
    #              [746537.555, 2564937.555],
    #              [746530.014, 2564939.248]]
...
# 将控制点转换为单精度浮点数
# src_pts = rcx_pts.astype(np.float32)
# dst_pts = ldk_pts.astype(np.float32)
