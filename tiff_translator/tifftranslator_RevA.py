...
# 对图像进行膨胀处理
# img2 = cv2.dilate(img2, kernel, iterations)
...
#
# ldk_resized = cv2.resize(img1, (0,0), fx=0.1, fy=0.1)
# roi_x, roi_y, roi_w, roi_h = cv2.selectROI(ldk_resized)
#
# img1 = ldk_resized[roi_y:roi_y+roi_h, roi_x:roi_x+roi_w]
#
#
# rcx_resized = cv2.resize(img2, (0,0), fx=0.25, fy=0.25)
#
# roi_x, roi_y, roi_w, roi_h = cv2.selectROI(rcx_resized)
#
# img2 = rcx_resized[roi_y:roi_y+roi_h, roi_x:roi_x+roi_w]
